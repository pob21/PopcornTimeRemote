...
- (void)loadView
{
    ...
    self.connectBtn.titleLabel.font = [UIFont systemFontOfSize: 24];
    ...
    self.connectBtn.frame = CGRectMake((self.view.frame.size.width/2)-160, self.divider.frame.origin.y + self.divider.frame.size.height + 40, 320, 76);
